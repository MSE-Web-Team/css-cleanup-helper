...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        for css_class in css_classes:
            if(css_class not in unique and ")" not in css_class and ";" and "'" not in css_class and "`" not in css_class and not in css_class and "," not in css_class and "rem" not in css_class and "7s" not in css_class):
